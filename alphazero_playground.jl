...
# ╔═╡ 7a43b386-77ac-11ec-234d-fbd742cd00f0
using AlphaZero, Plots

# ╔═╡ 30006381-a9ee-4828-9e09-bc4e39219752


# ╔═╡ dc123a58-3b6a-47e6-8fd4-a9da50b7762b
...
[[deps.AlphaZero]]
deps = ["ArgParse", "CUDA", "Colors", "CommonRLInterface", "Crayons", "DataStructures", "Distributed", "Distributions", "Documenter", "ExprTools", "Flux", "Formatting", "JSON3", "Knet", "LinearAlgebra", "Plots", "ProgressMeter", "Random", "Requires", "Serialization", "Setfield", "StaticArrays", "Statistics", "ThreadPools", "Zygote"]
git-tree-sha1 = "81af13335ecac62b89e520663dcf36cd07c46dcc"
...
git-tree-sha1 = "71379d23d245d9922192c6da509482f580941a92"
