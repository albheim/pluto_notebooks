...
# ╔═╡ fe98340c-f99a-4f60-83a0-0129cea4370f
using Flux, Plots

# ╔═╡ 4067605e-a4e8-467a-a3ad-69e9653169ce
function loss(m, xs, ys)
    loss = 0f0
    for (x, y) in zip(xs, ys)
        Flux.reset!(m) # Reset the state of the recursive cell
        loss += sum(exp2.(m(x)[:, end] - y)) 
    end
    loss 
end

# ╔═╡ d74c3412-f842-406e-a5c3-1054fab247c6
begin
	dim_feature = 4
	dim_sample = 100
	min_seq_length = 3
...
# ╔═╡ cc153df9-aa45-4fe2-89d1-2fc8ddd3414b
begin 
...
# ╔═╡ 694e1589-af26-4e0e-82cb-2059ffdca16b
begin
...
# ╔═╡ 44676050-2c77-467f-bfbc-26bd7fdffd03
