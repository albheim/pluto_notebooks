...
# ╔═╡ d92f13bd-608d-4486-a618-0a0cc6e358d2
using PlutoUI, ControlSystems, Unitful

# ╔═╡ fbf08202-d6a6-11ec-306a-9d95bc03eec2
begin
	# Easily measurable
	a = 1u"m"
	b = 1.5u"m"
...
# ╔═╡ 15937b58-093e-4a5e-8bfa-236e25d9e87e
Gsimple = tf([V*D, V^2*m*h], [b*J, 0, b*m*g*h])

# ╔═╡ 75690102-71a9-4221-af97-5ee54f42b95d
ss(1u"m", 3u"s", 4u"kg", 0u"kg")

# ╔═╡ 603c29c5-1d3f-444e-8bab-5eb6b8cb9e18
q = 3.3u"m"

# ╔═╡ 89824b95-f482-42f5-ae27-d2bd240a2b2e
typeof(q)
